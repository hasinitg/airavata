...
public class OAuthAppRegisteringClient {
    ...
    public boolean isAppRegistered(String appName) throws AiravataSecurityException {
        try {
            ...
            //get the appDTO by app name
            OAuthConsumerAppDTO appDTO = stub.getOAuthApplicationDataByAppName(appName);
            if (appDTO == null) {
                return false;
            } else {
                return true;
